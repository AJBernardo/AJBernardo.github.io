...
for (var i = 0; i < shows.length; i++) {
  ...
  showsList.innerHTML +=
    `<div class="col-lg-4 col-sm-6 col-12 mb-5">
        ...
        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#readSynopsisModal${i}">
          Read Synopsis
        </button>
    </div>

    <div class="modal fade" id="readSynopsisModal${i}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header bg-dark text-light">
          <h1 class="modal-title fs-5" id="exampleModalLabel">${shows[i].toUpperCase()}</h1>
