...
const getAllCategories = async () => {
    ...
    const url = 'http://localhost/Academics/COMP%20019/AJBernardo.github.io/ADET/A06/backend/categories.php';
...
const getProducts = async (categoryID) => {
    ...
    const url = 'http://localhost/Academics/COMP%20019/AJBernardo.github.io/ADET/A06/backend/products.php';
